...
use datafusion_optimizer::{
    ...
    optimize_projections::OptimizeProjections, push_down_filter::PushDownFilter,
...
impl LogicalPlanExamples {
    ...
    pub async fn setup_test_data(&self) -> Result<()> {
        ...
        let orders_batch = RecordBatch::try_new(
            ...
            vec![
                ...
                Arc::new(StringArray::from(vec![
                    "ON_SALE", "REGULAR", "ON_SALE", "REGULAR", "ON_SALE",
                ])),
                Arc::new(TimestampSecondArray::from(vec![
                    1640995200, 1640995200, 1640995200, 1640995200, 1640995200,
                ])),
            ],
        )?;
        ...
        let users_batch = RecordBatch::try_new(
            ...
            vec![
                ...
                Arc::new(TimestampSecondArray::from(vec![
                    1640995200, 1640995200, 1640995200,
                ])),
            ],
        )?;
    ...
    pub async fn optimize_and_print(&self, plan: LogicalPlan, title: &str) -> Result<()> {
        let optimized =
            self.optimizer
                .optimize(plan, &OptimizerContext::default(), |_plan, _rule| {})?;
    ...
    pub async fn example_simple_projection_filter(&self) -> Result<()> {
        ...
        self.optimize_and_print(plan, "Optimized Logical Plan")
            .await?;
