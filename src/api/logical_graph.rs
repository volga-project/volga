...
mod tests {
    ...
    use crate::executor::placement::{TaskPlacementStrategy, SingleWorkerStrategy, build_task_placement_mapping};
    ...
    fn test_logical_to_execution_graph_with_cluster() {
        ...
        // Use SingleWorkerStrategy to assign tasks to workers
        let placements = SingleWorkerStrategy.place_tasks(&execution_graph);
