...
mod tests {
    ...
    use crate::executor::placement::{TaskPlacementStrategy, SingleNodeStrategy, build_task_placement_mapping};
    ...
    fn test_logical_to_execution_graph_with_cluster() {
        ...
        // Use SingleNodeStrategy to assign tasks to workers
        let placements = SingleNodeStrategy.place_tasks(&execution_graph);
