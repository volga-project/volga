...
pub use backend::{
    ...
    InMemWindowStore, InMemWindowStoreClient, ScyllaWindowStore, ScyllaWindowStoreClient,
    StateVersion, Version, WindowBackendSnapshot, WindowOperatorStore, WindowRequestStore,
