...
fn test_worker_execution() -> Result<()> {
    ...
    connector_configs.sources.insert(
        ...
        (SourceConfig::VectorSourceConfig(VectorSourceConfig::new(test_messages)), schema),
    );
