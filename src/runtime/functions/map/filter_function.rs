...
impl FilterFunction {
    pub fn new(schema: DFSchemaRef, predicate: Expr, session_context: SessionContext) -> Self {
        let physical_expr = session_context
            .create_physical_expr(predicate.clone(), &schema)
            .unwrap();
...
mod tests {
    ...
    async fn test_filter_function() {
        ...
        let filter_func = FilterFunction::new(
        ...
        let filtered_value_array = filtered_batch
            .column(0)
            .as_any()
