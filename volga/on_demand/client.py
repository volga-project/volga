...
# Example request: http://host/on_demand_compute/{"target_features": ["simple_feature"], "feature_keys": {"simple_feature": [{"id": "test-id"}, {"id": "test-id-1"}, {"id": "test-id-2"}]}, "query_args": null, "udf_args": {"simple_feature": {"multiplier": 2.0}}}
